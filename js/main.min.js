...
let cityField=$("._city-field");function setStep(t){$(".calc-step").removeClass("_active"),$(`.calc-step[data-step="${t}"]`).addClass("_active"),$(`.calc-progress__item[data-step="${t}"]`).addClass("_filled")}$("._got-to-step1").click((function(){setStep(1)})),$("._got-to-step2").click((function(){setStep(2)})),$("._got-to-step3").click((function(){setStep(3)})),$("._got-to-step4").click((function(){setStep(4)})),$(cityField).on("input",(function(){""!==$(this).val()?$("._got-to-step2.m-btn-green").prop("disabled",!1):$("._got-to-step2.m-btn-green").prop("disabled",!0)})),$(".calc-cities__item").click((function(){let t=$(this).find("span").text();$(cityField).val(t),$(cityField).trigger("input")})),$('[data-name="certificates"]').change((function(){if(0!==$('[data-name="certificates"]:checked').length){$("._got-to-step3.m-btn-green").prop("disabled",!1);let t=0;$('[data-name="certificates"]:checked').each((function(e,c){t+=+$(c).attr("data-value")})),$("._sum").html(t.toLocaleString()+" рублей")}else $("._got-to-step3.m-btn-green").prop("disabled",!0),$("._sum").html("0 рублей")})),$('[data-name="useFor"]').change((function(){0!==$('[data-name="useFor"]:checked').length?$("._got-to-step4.m-btn-green").prop("disabled",!1):$("._got-to-step4.m-btn-green").prop("disabled",!0)}));
...
function fix100vh(){let e=.01*window.innerHeight;document.documentElement.style.setProperty("--vh",e+"px")}window.addEventListener("DOMContentLoaded",()=>{fix100vh(),window.addEventListener("resize",()=>{fix100vh(),getScrollBarSize()}),getScrollBarSize(),$(".fg select").change((function(){$(this).addClass("_selected")}))}),$(document).on("click",".qa-card__show",(function(e){$(this).parents(".qa-card").toggleClass("_active"),$(this).siblings(".qa-card__hidden").slideToggle()})),$(".city-select__show").click((function(){$(this).parents(".city-select").toggleClass("_open")})),$(document).mouseup((function(e){var t=$(".city-select");t.is(e.target)||0!==t.has(e.target).length||$(t).hasClass("_open")&&$(t).removeClass("_open")}));
